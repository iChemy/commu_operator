...
- `BODY_P`: 小さいほどのけぞる．大きいほど前傾姿勢になる．最小(`-15`)で胸を張る程度ののけぞり．最大(`15`)で普通のお辞儀程の前傾姿勢．
- `BODY_Y`: 小さいほど右に体を向ける．大きいほど左に体を向ける．最小(`-67`)で右前を向く．最大(`67`)で左前を向く．
- `L_SHOULDER_P`: 小さいほど左腕を挙げる．大きいほど下げる．最小(`-108`)で耳の後ろまで上げる．最大(`108`)で腰の横まで下げる．
- `L_SHOULDER_R`: 小さいほど左脇を開く．大きいほど閉じる．最小(`-45`)でものを抱えているように見えるくらい広がる．最大(`30`)で胸の前に手が来るほど脇を閉める．
  `L_SHOULDER_P` が大きいと，腕を閉める際に胴体に衝突して閉まり切らない．
- `R_SHOULDER_P`: 小さいほど右腕を下げる．大きいほど挙げる．最小(`-108`)で腰の横まで下げる．最大(`108`)で耳の後ろまで上げる．
- `R_SHOULDER_R`: 小さいほど右脇を閉じる．大きいほど開く．最小(`-30`)で胸の前に手が来るほど脇を閉める．最大(`45`)でものを抱えているように見えるくらい広がる．
  `R_SHOULDER_P` が小さいと，腕を閉める際に胴体に衝突して閉まり切らない．
- `HEAD_P`: 小さいほど頭を後ろに傾ける．大きいほど頷く．最小(`-20`)で斜め上を向くほど頭を後ろに傾ける．最大(`25`)で顎を首元に付けるほど頷く．
- `HEAD_R`: 小さいほど右に首を傾げる．大きいほど左に首を傾げる．最小(`-15`)で少し右に傾げる．最大(`15`)で少し左に傾げる．
- `HEAD_Y`: 小さいほど右に頭を向ける．大きいほど左に頭を向ける．最小(`-85`)で右横を向く．最大(`85`)で左横を向く．
- `EYE_P`: 小さいほど両目を下に向ける．大きいほど両目を上に向ける．最小(`-22`)で足元あたりに目を向ける．最大(`22`)でおでこあたりに目を向ける．
- `L_EYE_Y`: 小さいほど左目を右に向ける．大きいほど左に向ける．最小(`-35`)で右目を見るくらい目を向ける．最大(`20`)で左前を見るくらい目を向ける．
- `R_EYE_Y`: 小さいほど右目を右に向ける．大きいほど左に向ける．最小(`-20`)で右前を見るくらい目を向ける．最大(`35`)で左目を見るくらい目を向ける．
- `EYELIDS`: 小さいほど瞼を下ろす．大きいほど瞼を上げる．最小(`-65`)で目をほとんど閉じる．最大(`3`)で瞼が見えなくなるほど上げる．
